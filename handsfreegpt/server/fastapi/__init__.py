...
class FastAPI:
    def __init__(self, settings):
        ...
        self.router.add_api_route(
            "/api/v1/persist", self.persist, methods=["POST"]
        )
        self.router.add_api_route(
            "/api/v1/raw_sql", self.raw_sql, methods=["POST"]
        )
        ...
        self.router.add_api_route(
            "/api/v1/collections/{collection_name}/get",
            self.get,
            methods=["POST"],
        )
        self.router.add_api_route(
        ...
        self.router.add_api_route(
            "/api/v1/collections/{collection_name}/count",
            self.count,
            methods=["GET"],
        )
        self.router.add_api_route(
